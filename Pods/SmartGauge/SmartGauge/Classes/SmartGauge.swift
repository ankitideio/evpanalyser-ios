...
public class SmartGauge: UIView {
    ...
    public var gaugeAngle: CGFloat = 55.0 {
        didSet { updateUI() }
    }
    ...
    private func setupTrackLayer() {
        ...
        trackLayer?.gaugeValue = (gaugeValue ?? 0) * 1.10
...
//        print(gaugeValue as Any)
//        print(gaugeAngle)
//        print("gaugeAngle")
        if gaugeValue == Double() {
//            print(1)
            handleLayer?.gaugeAngle = gaugeAngle + 15
        } else {
//            print(2)
            handleLayer?.gaugeAngle = gaugeAngle + 8
        }
        handleLayer?.gaugeValue = (gaugeValue ?? 0) * 1.10
