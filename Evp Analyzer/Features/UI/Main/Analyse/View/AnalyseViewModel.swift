...
class AnalyseViewModel {
    ...
    init() {
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(AnalyseViewModel.didReceiveMeteringLevelUpdate),
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(AnalyseViewModel.didFinishRecordOrPlayAudio),
